...
const _writePool = new Pool({
	...
	database: 'toll_db',
	password: (process.env.PG_WRITE_PASSWORD ? process.env.PG_WRITE_PASSWORD : 'password'),
...
const _readPool = new Pool({
	...
	host: (process.env.PGHOST ? process.env.PGHOST : 'localhost'),
	database: 'toll_db',
	password: (process.env.PG_READ_PASSWORD ? process.env.PG_READ_PASSWORD : 'password'),
	port: (process.env.PGPORT ? process.env.PGPORT : 5432),
});
